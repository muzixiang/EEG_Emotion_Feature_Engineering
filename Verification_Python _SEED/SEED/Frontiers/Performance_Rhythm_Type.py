...
for rhy_no in range(0,rhythmNum):
    xfile = sio.loadmat('.//SubX_RhythmType//subX_rhythm_type_'+rhythms[rhy_no]+'_SEED.mat')
    subX_all = xfile['f']
    ## scale data
...
# save results
sio.savemat('acc_scores_subcross_rhythmtype.mat', {'results': acc_scores})
sio.savemat('f1_scores_subcross_rhythmtype.mat', {'results': f1_scores})
