...
for subNo in range(0, subNum):
    ...
    sel_indx = sel_indx[0]
    print sel_indx.shape
    print sel_indx
    feature_number_count[0, sel_indx] = feature_number_count[0, sel_indx] + 1
...
if emodim==0:
    #save results
    sio.savemat('valence_feature_number_count_RFE_Revision.mat', {'results': feature_number_count})
else:
    sio.savemat('arousal_feature_number_count_RFE_Revision.mat', {'results': feature_number_count})