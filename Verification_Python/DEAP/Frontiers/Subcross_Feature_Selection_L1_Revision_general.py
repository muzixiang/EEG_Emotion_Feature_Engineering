...
#load data Y
file1 = sio.loadmat('.//trial_labels_general_valence_arousal_dominance.mat')
Y = file1['trial_labels']


f1_scores = np.zeros((90,32))
acc_scores = np.zeros((90,32))
...
if emodim==0:
    #save results
    sio.savemat('f1_scores_valence_subcross_100steps_L1_Revision_general.mat', {'results': f1_scores})
    sio.savemat('acc_scores_valence_subcross_100steps_L1_Revision_general.mat', {'results': acc_scores})
else:
    sio.savemat('f1_scores_arousal_subcross_100steps_L1_Revision_general.mat', {'results': f1_scores})
    sio.savemat('acc_scores_arousal_subcross_100steps_L1_Revision_general.mat', {'results': acc_scores})