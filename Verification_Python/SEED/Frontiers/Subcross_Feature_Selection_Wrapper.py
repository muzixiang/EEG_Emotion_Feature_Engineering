...
for no_k in range(0,91):
    ...
    for subNo in range(0, subNum):
            ...
            print('current sub performance:', f1_scores[no_k,subNo], ' kbest:', num_k)


#save results
sio.savemat('f1_scores_valence_subcross_91steps_wrapper_step_0dot5.mat', {'results': f1_scores})
