...
f1_scores = np.zeros((457,3,subNum))
acc_scores = np.zeros((457,3,subNum))
...
#save results
sio.savemat('f1_scores_valence_subcross_457steps_filter.mat', {'results': f1_scores})
sio.savemat('acc_scores_valence_subcross_457steps_filter.mat', {'results': acc_scores})
